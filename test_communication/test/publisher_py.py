...
def fill_msg(msg, message_name, i):
    if 'Builtins' == message_name:
        ...
        msg.uint16_values = [int(i + x) for x in range(len(msg.int16_values))]
        msg.int32_values = [int(-(i + x)) for x in range(len(msg.int16_values))]
        msg.uint32_values = [int(i + x) for x in range(len(msg.int16_values))]
        msg.int64_values = [int(-(i + x)) for x in range(len(msg.int16_values))]
        msg.uint64_values = [int(i + x) for x in range(len(msg.int16_values))]
